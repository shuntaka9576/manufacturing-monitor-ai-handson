...
| ch2 → ch3     | `db/__init__.py`, `db/schema.sql`, `db/seed.py`, `sample_data.xlsx`, `tests/__init__.py`, `tests/test_seed.py`                             |
| ch3 → ch4     | 上記 + `app.py`, `db/connection.py`, `pages/01_equipment_dashboard.py`                                                                     |
...
| ch3          | ch2のファイル（`dashbord.png`除く） + `app.py`, `db/connection.py`, `pages/01_equipment_dashboard.py`                          |
...
| ------------- | ----------------------------------------------------------------- |
| ch2 → ch3     | `steering/sample-data-structure.md`                               |
| ch3 → ch4     | `steering/sample-data-structure.md`, `steering/dashboard-spec.md` |
| ch4 → ch5     | `.kiro/` 配下すべて                                               |
