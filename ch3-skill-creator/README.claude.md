...
- （後半用）GitHub CLI v2.90.0+。導入方法は [SETUP.claude.md](../SETUP.claude.md) §9 を参照
...
> [!NOTE]
> 事前に [SETUP.claude.md §9](../SETUP.claude.md) を見て GitHub CLI v2.90.0+ を用意してください。`gh skill` は Public Preview のため仕様変更の可能性があります。
